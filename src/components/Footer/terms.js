  ...
  return (
    <div>
      <h2>
        ...
        <span class="website_url">https://www.agrlandscapes.com</span>
      </h2>
      ...
      <p>
        ...
        <span class="website_url">https://www.agrlandscapes.com</span> (the
        "Website").
      </p>

      <p>
        Please read the Terms and Conditions carefully before you start using{" "}
        <span class="website_name">A.G. Residential Landscapes</span>, because
      ...
      <p>
        ...
        <span class="date">[DATE]</span>. We expressly reserve the right to
      ...
      <p>
        ...
        <span class="website_name">A.G. Residential Landscapes</span>.
      </p>
      ...
      <p>
        Your use of{" "}
        <span class="website_name">A.G. Residential Landscapes</span> is at your
        sole risk. The Website is provided "as is" and "as available". We
      ...
      <p>
        ...
        you create a{" "}
        <span class="website_name">A.G. Residential Landscapes</span> account or
        when you start using the{" "}
        <span class="website_name">A.G. Residential Landscapes</span> and will
        remain effective until terminated by you or by us.{" "}
      </p>

      <p>
        <span class="website_name">A.G. Residential Landscapes</span> reserves
        the right to terminate this Terms and Conditions or suspend your account
        ...
        otherwise. If{" "}
        <span class="website_name">A.G. Residential Landscapes</span> terminates
        this Terms and Conditions, or suspends your account for any of the
        reasons set out in this section,{" "}
        <span class="website_name">A.G. Residential Landscapes</span> shall have
      ...
      <p>
        <span class="website_name">A.G. Residential Landscapes</span> may assign
        this Terms and Conditions or any part of it without restrictions. You
        may not assign this Terms and Conditions or any part of it to any third
        party.
      </p>
      ...
      <p>
        ...
        the internal laws of the <span class="country">us</span> without giving
      ...
      <p>
        ...
        the federal courts of <span class="country">us</span>.
      </p>
    </div>
  );
};
